...
public static class Rng
{
    ...
    public static T Random<T>(this T[] array) => array[Int(array.Length - 1)];
    public static T Random<T>(this List<T> list) => list[Int(list.Count - 1)];
    public static T Random<T>(this Array array) => (T) array.GetValue(Int(array.Length - 1));
