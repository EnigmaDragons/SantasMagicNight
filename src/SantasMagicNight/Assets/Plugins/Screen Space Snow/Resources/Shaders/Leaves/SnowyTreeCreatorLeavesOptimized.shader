...
Shader "Hidden/Nature/Snowy Tree Creator Leaves Optimized" {
Properties {
...
// Defines we need to include snow helpers
...
void surf (Input IN, inout LeafSurfaceOutput o) {
    ...
    float coverage = tex2D(_Coverage, IN.screenPos.xy / IN.screenPos.w).r;

    c.rgb = lerp(c.rgb, 1.0f, coverage);
...
Dependency "BillboardShader" = "Hidden/Nature/Snowy Tree Creator Leaves Rendertex"
}
